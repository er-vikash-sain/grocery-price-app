...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf($_POST['csrf_token'] ?? null)) {
        ...
        if ($name === '') {
            ...
            if ($error === '') {
                $stmt = $db->prepare(
                    'INSERT INTO products (name, description, image, tags, is_active, created_at, updated_at)
                     VALUES (:name, :description, :image, :tags, 1, NOW(), NOW())'
                );
...
render_header('Add Product - Price Tracker', 'products');
...
<header class="mb-8">
    <h1 class="text-3xl font-semibold text-[#0F172A] tracking-tight">Add Product</h1>
    <p class="subtitle">Create a new product for price tracking</p>
</header>
    ...
    <div class="card-body">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <p class="file-hint">Accepted formats: JPG, PNG, GIF, WEBP (Max 5MB)</p>
            </div>
