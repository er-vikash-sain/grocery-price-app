...
render_header('Edit Store - Price Tracker', 'stores');
...
<header class="mb-8">
    <h1 class="text-3xl font-semibold text-[#0F172A] tracking-tight">Edit Store</h1>
    <p class="subtitle">Update store details and location information</p>
</header>
